...
impl Odometry {
    ...
    pub fn transform_utm_to_local_frames(
        &self,
        relative_northing: f64,
        relative_easting: f64,
    ) -> Vector2<f64> {
        /*
         * returns (x, y)
         * X-axis => North axis
        ...
        Matrix2::new(-1f64, 0f64, 0f64, 1f64)
            * Matrix2::new(cosine, -sine, sine, cosine)
            * Vector2::new(relative_northing, relative_easting)
    }
    // c, s, -s, c gives (-22, 13)
